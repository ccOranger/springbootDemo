...
//		String url = "https://www.yezhuwuyou.com/#/home";
	...
	public static String getDocument(String url) throws IOException, InterruptedException{
		...
		wc.setJavaScriptTimeout(1000000);
		//不跟踪抓取
		...
		request.setAdditionalHeader("Cookie","authorization=d1e0fa18302a99ef3f566421a69318eb; userInfo=%257B%2522id%2522%253A%25221252832654852751362%2522%252C%2522account%2522%253A%252215900935478%2522%252C%2522password%2522%253Anull%252C%2522phone%2522%253A%252215900935478%2522%252C%2522userName%2522%253Anull%252C%2522headUrl%2522%253Anull%252C%2522openId%2522%253A%2522odIUfxFymLyQTlnlQZ-kBMxLzrbo%2522%252C%2522type%2522%253A%25220%2522%252C%2522sourceType%2522%253A%25221%2522%252C%2522sourceCity%2522%253A%2522%2522%252C%2522sourceRegion%2522%253A%2522%2522%252C%2522sourceCityId%2522%253A%2522%2522%252C%2522sourceRegionId%2522%253A%2522%2522%252C%2522isBuy%2522%253A%25221%2522%252C%2522isOld%2522%253A%25221%2522%252C%2522status%2522%253A%25220%2522%252C%2522createTime%2522%253A%25222020-04-22%252013%253A32%253A36%2522%252C%2522modifyTime%2522%253A%25222020-04-28%252015%253A44%253A42%2522%257D; Hm_lvt_117e36d8e26416aeb6355c74ff6b6de3=1598854820,1599036316,1599122988,1599183534; Hm_lpvt_117e36d8e26416aeb6355c74ff6b6de3=1599184385");

		try {
			//模拟浏览器打开一个目标网址
			HtmlPage htmlPage = wc.getPage(request);
			htmlPage.executeJavaScript("document.documentElement.outerHTML");
