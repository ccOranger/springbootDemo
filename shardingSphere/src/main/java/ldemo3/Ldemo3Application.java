...
public class Ldemo3Application implements ApplicationRunner {
	private static final Logger logger = LoggerFactory.getLogger(Ldemo3Application.class);
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(Ldemo3Application.class, args);
	}
